#!/bin/bash
#SBATCH --job-name="females-map-grch38"
#SBATCH -o /data/CEM/wilsonlab/lab_generated/kenya/hassler/scripts/logs/slurm_%A.out
#SBATCH -e /data/CEM/wilsonlab/lab_generated/kenya/hassler/scripts/logs/slurm_%A.err
...
# NOTE modified for female wgs 7/10/25
...
REFS="/data/CEM/wilsonlab/lab_generated/kenya/hassler/refs/grch38/GRCh38_full_analysis_set_plus_decoy_hla_YHardMasked.fa"
SAMPLE=$(sed -n "$((SLURM_ARRAY_TASK_ID+1))p" /data/CEM/wilsonlab/lab_generated/kenya/hassler/scripts/manifest/females.txt)
#SAMPLE="A11"
TYPE="wgs"
REF_NAME="yhard.grch38"
...
# example output: A11.wgs.yhard.grch38.sorted.bam
